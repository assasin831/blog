      ...
      '/posts/': [
        {
          text: '每日记录',
          items: [
            { text: '2026-06-28 SmartMall AI 秒杀活动与日志补齐', link: '/posts/2026-06-28.html' },
            { text: '2026-06-27 SmartMall AI 部署清单整理', link: '/posts/2026-06-27.html' },
            { text: '2026-06-26 博客每日记录分页维护', link: '/posts/2026-06-26.html' },
            { text: '2026-06-25 SmartMall AI 缓存 MQ 运维复盘', link: '/posts/2026-06-25.html' },
            { text: '2026-06-24 SmartMall AI 构建回归检查', link: '/posts/2026-06-24.html' },
            { text: '2026-06-23 SmartMall AI 秒杀安全边界', link: '/posts/2026-06-23.html' },
            { text: '2026-06-22 SmartMall AI outbox 与 RabbitMQ 复盘', link: '/posts/2026-06-22.html' },
            { text: '2026-06-21 SmartMall AI 性能观测与分页验证', link: '/posts/2026-06-21.html' },
            { text: '2026-06-20 SmartMall AI 管理后台信息密度', link: '/posts/2026-06-20.html' },
            { text: '2026-06-19 SmartMall AI 用户端秒杀入口', link: '/posts/2026-06-19.html' },
            { text: '2026-06-18 SmartMall AI 订单与秒杀索引', link: '/posts/2026-06-18.html' },
            { text: '2026-06-17 SmartMall AI DLQ 审计展示', link: '/posts/2026-06-17.html' },
            { text: '2026-06-16 SmartMall AI DLQ 审计表设计', link: '/posts/2026-06-16.html' },
            { text: '2026-06-15 SmartMall AI 秒杀请求分页', link: '/posts/2026-06-15.html' },
            { text: '2026-06-14 SmartMall AI 秒杀活动后台', link: '/posts/2026-06-14.html' },
            { text: '2026-06-13 SmartMall AI campaignId 库存隔离', link: '/posts/2026-06-13.html' },
            { text: '2026-06-12 SmartMall AI 秒杀活动表设计', link: '/posts/2026-06-12.html' },
